...
// Carte affichant un babysitter (ou utilisateur trouvé lors d’une recherche).
// On y voit : avatar, nom, prix, âge, nombre de gardes, note en étoiles, distance et un bouton d’action.
