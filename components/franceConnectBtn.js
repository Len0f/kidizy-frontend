...
export default function FranceConnectBtn(){
    ...
    return (
                ...
                <TouchableOpacity onPress={()=>handleSummit()}style={styles.btnContainer}>
                    <Image  style={styles.logoFranceConnect} source={require('../assets/Logo_FranceConnect.svg.png')}/>
                    <View style={styles.textContainer}><Text style={styles.textBtn2}> Ici</Text></View>
                </TouchableOpacity>
