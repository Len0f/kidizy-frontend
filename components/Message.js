...
export default function Message(props) {
    ...
    return (
    <View style={[styles.messageWrapper, { ...(props.username === props.params.username ? styles.messageSent : styles.messageRecieved) }]}>
        <Image style={(props.username != props.params.username ? styles.image : styles.imageNone)} source={require(props.imageURL)} />
        <View style={[styles.message, { ...(props.username === props.params.username ? {backgroundColor: props.colorBG} : {backgroundColor: '#EBE6DA'}) }]}>
